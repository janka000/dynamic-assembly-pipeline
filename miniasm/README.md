...
This is a (commended and) slightly modified version of https://github.com/lh3/miniasm, so that it can output the results in multiple formats, including the set of the reads used for the assembly. 

# Miniasm repositiory README:
## Getting Started
