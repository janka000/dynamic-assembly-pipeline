...
/**
 * store read into the hash table
 * 
 * @param sdict_t *d hash table
 * @param const char *name read name
 * @param uint32_t len length of the read
 * 
 * @return stored value (?) 
 * 
*/
...
/**
 * remove the sequences marked for deletion..
 * 
 * @returns map - mapping to indices after deletion (from old to new)
*/
