...
class StatsThreadSafe:
    """
    class for computing stats for completed assembly, creates bam files, matplotlib usage in this version sholud be thread safe
    """
    ...
    def draw_coverage(self, lock, log):
        try:
            ...
            if len(self.contigs) > 1:
                ...
                fig.savefig(fname, bbox_inches='tight',dpi=1, figsize=(10,10))
            ...
            fig.savefig(bar, bbox_inches='tight',dpi=100)
            fig.close()
    ...
    def reference_coverage(self, bed, out_png, bamfile, lock, log):
        ...
        try:
            ...
            if len(contigs) > 1:
                ...
                fig.savefig(out_png, bbox_inches='tight',dpi=1, figsize=(10,10))
                #plt.savefig(fname_ylim, bbox_inches='tight',dpi=1)
            fig.close()
